...
\begin{enumerate}
\item Produce a PCER Event with Payload of 4 bytes. Check that that node does not reinitialize.
\item Produce a PCER Event with Payload of 8 bytes. Check that that node does not reinitialize.
\item Produce a PCER Event with Payload of 12 bytes. Check that that node does not reinitialize.
\item Produce a PCER Event with Payload of 16 bytes. Check that that node does not reinitialize.
\item Produce a PCER Event with Payload of 20 bytes. Check that that node does not reinitialize.
\item Produce a PCER Event with Payload of 24 bytes. Check that that node does not reinitialize.
\end{enumerate}
