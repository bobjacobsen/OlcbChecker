...
This section checks the interaction in 
Standard section 3.4.3 Protocol Support Inquiry (PIP) and Response.
...
\item Sending three Protocol Support Inquiry messages from three separate source node IDs
...
\subsection{Simple Protocol Bits}

This checks message bits defined in Standard section 4.1.4

This checks that the PIP Simple Protocol subset bit is consistent with the MTI
